...
*/
  ...
  def setTippsWithoutUrlToDeleted(){
    ...
    Integer tippsToRemoved = tippsIds ? KBComponent.executeUpdate("update KBComponent set status = :removed, lastUpdated = CURRENT_DATE where id in (:tippIds)", [removed: RDStore.KBC_STATUS_REMOVED, tippIds: tippsIds]) : 0
