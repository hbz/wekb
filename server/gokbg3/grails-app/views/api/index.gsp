...
<html>
  <head>
    ...
    <title><g:message code="gokb.appname" default="we:kb"/> API</title>
  </head>
  <body>
    <div class="container">
      API Page
      ...
      <g:message code="gokb.appname" default="we:kb"/> ingest format specification. RED files meeting this format are ingested using the <g:link controller="api" action="ingest">ingest</g:link> api.</p>
