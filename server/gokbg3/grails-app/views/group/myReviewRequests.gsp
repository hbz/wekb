...
<head>
    ...
    <title><g:message code="gokb.appname"
                      default="we:kb"/>: My Review Requests of Curatory Groups (${groups.name.join(',')})</title>
</head>

<body>
<h1 class="ui header">My Review Requests of Curatory Groups (${groups.name.join(',')})</h1>
