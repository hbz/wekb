...
<dl class="dl-horizontal">
  ...
  <g:form controller="ajaxSupport" action="grant" class="form-inline">
    ...
    <dt>To</dt><dd><semui:simpleReferenceDropdown class="form-control" name="grantee" baseClass="org.gokb.cred.User" /></dd>
  ...
  <g:form controller="ajaxSupport" action="grant" class="form-inline">
    ...
    <dt>To</dt><dd><semui:simpleReferenceDropdown class="form-control" name="grantee" baseClass="org.gokb.cred.Role" /></dd>
    <dt></dt><dd><button type="submit" class="btn btn-default btn-primary btn-sm ">Add</button></dd>
  </g:form>
</dl>
