...
//    }
    ...
    def refdataCats() {
        ...
        RefdataCategory.lookupOrCreate(RCConstants.IDENTIFIER_NAMESPACE_TYPE, 'Org').save(flush: true, failOnError: true)
        RefdataCategory.lookupOrCreate(RCConstants.IDENTIFIER_NAMESPACE_TYPE, 'Package').save(flush: true, failOnError: true)
        RefdataCategory.lookupOrCreate(RCConstants.IDENTIFIER_NAMESPACE_TYPE, 'Title').save(flush: true, failOnError: true)
        RefdataCategory.lookupOrCreate(RCConstants.IDENTIFIER_NAMESPACE_TYPE, 'Book').save(flush: true, failOnError: true)
        RefdataCategory.lookupOrCreate(RCConstants.IDENTIFIER_NAMESPACE_TYPE, 'Journal').save(flush: true, failOnError: true)
        RefdataCategory.lookupOrCreate(RCConstants.IDENTIFIER_NAMESPACE_TYPE, 'Database').save(flush: true, failOnError: true)
        RefdataCategory.lookupOrCreate(RCConstants.IDENTIFIER_NAMESPACE_TYPE, 'Other').save(flush: true, failOnError: true)
